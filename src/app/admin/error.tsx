...
export default function AdminError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-4 text-center">
      ...
      <h2 className="text-2xl font-bold tracking-tight mb-2">Admin Panel Error</h2>
      <p className="text-text-muted max-w-md mb-4">
        An unexpected error occurred in the administration dashboard. Your session remains active.
      </p>
