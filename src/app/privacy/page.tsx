...
export default function Page() {
  return (
    <LegalPage
      ...
      intro="How AlphaCapital collects, uses, and protects your personal data. This is placeholder content — the operator should replace it with a policy reviewed by qualified counsel before launch."
      updated="May 2026"
      sections={[
