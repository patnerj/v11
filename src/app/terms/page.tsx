...
export default function Page() {
  return (
    <LegalPage
      ...
      intro="By using Alpha Capital you agree to the following terms."
      updated="May 2026"
      sections={[
        { title: '1. The service',
          body: <p>Alpha Capital provides a simulated trading evaluation programme. Funded accounts are demonstration accounts that mirror real-market prices; payouts represent the operator&apos;s share of allocated capital and are not the result of executions on a live broker account.</p> },
        { title: '2. Eligibility',
